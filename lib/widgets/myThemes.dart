    ...
    bottomNavigationBarTheme: BottomNavigationBarThemeData(
      ...
      textTheme:
          TextTheme(
            ...
            overline: TextStyle(color: Colors.grey[600], fontSize: 25),
              headline3: TextStyle(color: Colors.black, fontSize: 18),
            headline2: TextStyle(color: Colors.black, fontSize: 12),
            headline4: TextStyle(color: Colors.grey[400], fontSize: 16),
              headline1: TextStyle(color: Colors.blue[400], fontSize: 12, decoration: TextDecoration.underline),  //terms of service
          ),
  ...
  static final ThemeData darkTheme = ThemeData(
    ...
    dividerTheme: DividerThemeData(
      ...
      textTheme: TextTheme(
        ...
        headline1: TextStyle(color: Colors.blue[400], fontSize: 12, decoration: TextDecoration.underline), // subtitle style
        subtitle1: TextStyle(color: Colors.white70, fontSize: 10), //time
        subtitle2: TextStyle(color: Colors.blue[400], fontSize: 16),
        bodyText1: TextStyle(color: Colors.blue[400], fontSize: 12,), //Dialog options text
        bodyText2: TextStyle(
            color: Colors.blue[400], fontSize: 16), //Dialog options text
        button: TextStyle(color: Colors.white70, fontSize: 8),
        overline: TextStyle(color: Colors.white70, fontSize: 25),
      ),
      appBarTheme: AppBarTheme(
          color: Colors.blueGrey[800],
