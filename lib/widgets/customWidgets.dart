...
Widget customRaisedButton(
    {String label, var function, Color textColor, Color backgroundColor}) {
  return Padding(
...
Widget chatListTile(
    {BuildContext context, String name, String time, String message}) {
  return Container(
    child: Padding(
...
Widget discoverIcon({BuildContext context}) {
  return Stack(
    children: [
      Icon(
        Icons.explore,
